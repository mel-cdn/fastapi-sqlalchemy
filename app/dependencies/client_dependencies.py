...
from repositories.dynamodb.client_repository import ClientRepository as DynamoClientRepository
from repositories.pgsql.client_repository import ClientRepository as PostgresClientRepository
